...
class RecapAbsensiScreen extends StatefulWidget {
  const RecapAbsensiScreen({super.key});

  @override
  State<RecapAbsensiScreen> createState() {
    return _RecapAbsensiScreen();
  }
}

class _RecapAbsensiScreen extends State<RecapAbsensiScreen> {
  @override
