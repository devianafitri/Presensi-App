...
import 'package:flutter_application_1/screen/recap_absensi_screen.dart';
import 'package:google_fonts/google_fonts.dart';
import 'package:flutter_svg/flutter_svg.dart';
import 'package:flutter_application_1/model/presensi.dart';
import 'package:flutter_application_1/utils/mix.dart';
                ...
                GestureDetector(
                  onTap: () {
                    Navigator.of(context).push(
                      MaterialPageRoute(
                        builder: (context) => const RecapAbsensiScreen(),
                      ),
                    );
                  },
                  child: Text(
